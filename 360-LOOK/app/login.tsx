...
const SimpleForm = (props: Whichform) => {
...
else
  {
    ...
    <View style={styles.container}>
      ...
      <Controller
        ...
        render={({ field }) => (
          <View style={my_style.look}>
            <View style={my_style.bloc_b3}>
              <Image style={my_style.profil} source={require('@/drawable/la-personne.png')}></Image>
            <TextInput
              {...field}
              style={my_style.form}
    ...
    <View style={styles.se_connecter}>
